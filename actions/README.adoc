...
[source,yaml]
----
- uses: spring-data/spring-data-build/actions/maven-build@3.5.x
  with:
...
[source,yaml]
----
- uses: spring-data/spring-data-build/actions/maven-artifactory-deploy@3.5.x
  with:
...
[source,yaml]
----
- uses: spring-data/spring-data-build/actions/setup-mongodb@3.5.x
  with:
...
[source,yaml]
----
- uses: spring-data/spring-data-build/actions/env-config@3.5.x
----
====
...
[source,yaml]
----
- uses: spring-data/spring-data-build/actions/setup-java@3.5.x
  with:
...
[source,yaml]
----
- uses: spring-data/spring-data-build/actions/setup-maven@3.5.x
  with:
    # The Java version to set up. Takes main, next, latest, or a whole or semver Java version.
    # Default: 'main'
    java-version: ''
...
[source,yaml]
----
- uses: spring-data/spring-data-build/actions/test-summary@3.5.x
  with:
