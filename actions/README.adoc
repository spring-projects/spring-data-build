...
[source,yaml]
----
- uses: spring-data/spring-data-build/actions/maven-build@main
  with:
...
[source,yaml]
----
- uses: spring-data/spring-data-build/actions/maven-artifactory-deploy@main
  with:
...
[source,yaml]
----
- uses: spring-data/spring-data-build/actions/setup-mongodb@main
  with:
...
[source,yaml]
----
- uses: spring-data/spring-data-build/actions/env-config@main
----
====
...
[source,yaml]
----
- uses: spring-data/spring-data-build/actions/setup-java@main
  with:
...
[source,yaml]
----
- uses: spring-data/spring-data-build/actions/setup-maven@main
  with:
    # The Java version to set up. Takes main, next, latest, or a whole or semver Java version.
    # Default: 'main'
    java-version: ''
...
[source,yaml]
----
- uses: spring-data/spring-data-build/actions/test-summary@main
  with:
